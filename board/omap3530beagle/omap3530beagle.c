...
void audio_init()
{
	...
	*((uint *) 0x49022020) = 0x00000000;
	*((uint *) 0x49022024) = 0x00000000;
...
void dss_init()
{
	unsigned int i;
	int offset = 0;
	unsigned int beagle_width = 1280;
	unsigned int beagle_height = 110;
	...
	/* Add blank "image" data, replace this with a real image */
	for (i = 0; i < ((beagle_width * beagle_height) * 2); i += 2) {
		*((unsigned short *) (0x80500000 + i + offset)) = 0xffff;	
	}
